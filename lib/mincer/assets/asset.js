...
/** internal
 *  Asset.load(json) -> Asset
 *  - json (String):
 *
 *  Unserializes asset from JSON string.
 **/
Asset.load = function (/* json */) {
  return null;
};


/** internal
 *  Asset.dump(asset) -> String
 *  - asset (Asset):
 *
 *  Serializes asset into JSON string.
 **/
Asset.dump = function (/* asset */) {
